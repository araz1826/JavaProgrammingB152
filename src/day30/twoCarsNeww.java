...
public class twoCarsNeww {
    public static void main(String[] args) {
       ...
       for(String item: cars){                       //choose honda cars and split in brand and model separetly
           if(item.startsWith("Honda")){
               String[] splitter= item.split("-");

               System.out.println("Car make is "+splitter[0]+ " Car model is"+ splitter[1]);
