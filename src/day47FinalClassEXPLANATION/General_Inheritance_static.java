...
public class General_Inheritance_static {
    ...
    // show me your age not all, then use instance.

    /*static VS instance field

    static field :

    a field marked as static
...
--------Inheritance -----------
you can inherite any type of field: both instance and static
    access modifier
...
--- overriding
only the instance method can be overridden:  if you inherit from super class.

if there is no inherit so there is no override.
Even if their is an inherit, has to have a same access modifier but not private, has to be a visible. public or default

sub class can override the content of inherited super class instance method.
Sub class can provide
its own implementation of
inherited super class instance methods
This is called overriding.
We can optionally use @Override to make it clear (anything start with @ it is anotation)
